A sample repository that i am working on to create a react reasponsive search - results tables. Using react virtualized table, because it is awesome and fast to render virtualized component.
